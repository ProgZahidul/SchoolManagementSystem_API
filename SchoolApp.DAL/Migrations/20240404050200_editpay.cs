...
{
    /// <inheritdoc />
    public partial class editpay : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbsAcademicYears", x => x.AcademicYearId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCourseFeeAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbsCourseFees", x => x.CourseFeeId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "dbsCourseFeeDetails",
                columns: table => new
                {
                    CourseFeeDetailsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CourseFeeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbsCourseFeeDetails", x => x.CourseFeeDetailsId);
                    table.ForeignKey(
                        name: "FK_dbsCourseFeeDetails_dbsCourseFees_CourseFeeId",
                        column: x => x.CourseFeeId,
                        principalTable: "dbsCourseFees",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbsPayments", x => x.PaymentId);
                    table.ForeignKey(
                        name: "FK_dbsPayments_Student_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Student",
                        principalColumn: "StudentId");
                    table.ForeignKey(
                        name: "FK_dbsPayments_dbsCourseFees_CourseFeeId",
                        column: x => x.CourseFeeId,
                        principalTable: "dbsCourseFees",
                        principalColumn: "CourseFeeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbsAcademicMonths", x => x.MonthId);
                    table.ForeignKey(
                        name: "FK_dbsAcademicMonths_dbsPayments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "dbsPayments",
                        principalColumn: "PaymentId");
                });

            migrationBuilder.CreateTable(
                name: "dbsPaymentDetails",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbsPaymentDetails", x => x.PaymentDetailsId);
                    table.ForeignKey(
                        name: "FK_dbsPaymentDetails_dbsPayments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "dbsPayments",
                        principalColumn: "PaymentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "StudentId");
                    table.ForeignKey(
                        name: "FK_DueBalance_dbsPayments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "dbsPayments",
                        principalColumn: "PaymentId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "StandardId");
                    table.ForeignKey(
                        name: "FK_FeeStructure_dbsCourseFees_CourseFeeId",
                        column: x => x.CourseFeeId,
                        principalTable: "dbsCourseFees",
                        principalColumn: "CourseFeeId");
                });
            ...
            migrationBuilder.InsertData(
                table: "dbsAcademicMonths",
                columns: new[] { "MonthId", "MonthName", "PaymentId" },
                values: new object[,]
                {
                    { 1, "January", null },
                    { 2, "February", null },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dbsAcademicMonths_PaymentId",
                table: "dbsAcademicMonths",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_dbsCourseFeeDetails_CourseFeeId",
                table: "dbsCourseFeeDetails",
                column: "CourseFeeId");

            migrationBuilder.CreateIndex(
                name: "IX_dbsPaymentDetails_PaymentId",
                table: "dbsPaymentDetails",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_dbsPayments_CourseFeeId",
                table: "dbsPayments",
                column: "CourseFeeId");

            migrationBuilder.CreateIndex(
                name: "IX_dbsPayments_StudentId",
                table: "dbsPayments",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_DueBalance_PaymentId",
                table: "DueBalance",
                column: "PaymentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeeStructure_CourseFeeId",
                table: "FeeStructure",
                column: "CourseFeeId");
